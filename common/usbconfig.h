...
#endif
/* Этот макрос является хуком, если Вам нужно знать, когда произошел USB RESET. Он имеет
 *  один параметр, который позволяет отличить начало и конец состояния RESET.
 */
 ...
 * HID class 3, не требуется подклассов и протоколов (может оказаться удобным!)
